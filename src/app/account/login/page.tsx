    ...
    <div className="min-h-[calc(100dvh-56px)] flex items-center justify-center px-6 py-12">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          <h1 className="font-serif text-2xl font-bold text-glam-text mb-1">Welcome back</h1>
          <p className="text-sm text-muted">Sign in to manage your bookings</p>
        </div>
        ...
        <div className="bg-white rounded-3xl p-7 border border-border shadow-sm shadow-primary/5">
          <form onSubmit={handleSubmit} className="space-y-4" noValidate>
            ...
            <div>
              <label htmlFor="password" className="block text-xs font-semibold text-glam-text mb-1.5">Password</label>
              <div className="relative">
                ...
                <input id="password" type={showPw ? "text" : "password"} required autoComplete="current-password"
                  ...
                  className={`${INPUT} pl-10 pr-12`} placeholder="••••••••" />
          ...
          <div className="mt-5 text-center space-y-2">
            <Link href="/account/reset-password" className="text-xs text-muted hover:text-primary transition-colors duration-150 cursor-pointer">
              Forgot your password?
            </Link>
            <p className="text-xs text-muted">
              No account?{" "}
              <Link href="/account/register" className="text-primary font-semibold hover:underline cursor-pointer">
                Create one
              </Link>
            </p>
          </div>
